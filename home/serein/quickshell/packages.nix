  ...
  caelestia-cli = pkgs.stdenv.mkDerivation rec {
    ...
    patchPhase = ''
      ...
      find . -name "*.fish" -type f | while read -r file; do
        ...
        sed -i 's|\$HOME/hyprnix/home/assets/wallpapers|\$HOME/hyprnix/home/assets/wallpapers|g' "$file"
        sed -i 's|"~/hyprnix/home/assets/wallpapers"|"~/hyprnix/home/assets/wallpapers"|g' "$file"
      done
